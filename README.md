...
TweetBox is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x]completedUser can **sign in to Twitter** using OAuth login
* [x]loginUser can **view tweets from their home timeline**
